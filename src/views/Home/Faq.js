...
export default function Faq() {
  ...
  useEffect(() => {
    const obj = { authenticate_key: "abcd123XYZ" };
    postRecord(APIGetFaqData, obj).then((res) => {
      if (res.data[0].response.status === "success") {
              ...
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                  <a
                    ...
                    aria-controls="home"
                  >
                    {faqData.length > 0 ? faqData[0].title : ""}
                  </a>
                </li>
                <li class="nav-item">
                  <a
                  ...
                  >
                    {faqData.length > 0 ? faqData[1].title : ""}
                  </a>
                </li>
                <li class="nav-item">
                  <a
                  ...
                  >
                    {faqData.length > 0 ? faqData[2].title : ""}
                  </a>
                </li>
              </ul>
            </div>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="pag2" role="tabpanel">
                  <div id="accordion2" class="myaccordion">
                    {dayShoot.length > 0
                      ? dayShoot.map((res, index) => (
                          <div class="card">
                            <div
                              class="card-header"
                              id={"tab2headingOne" + index}
                            >
                              <button
                                class="d-flex align-items-center justify-content-between btn btn-link collapsed"
                                data-toggle="collapse"
                                data-target={"#tab2collapseOne" + index}
                                aria-expanded="false"
                            ...
                            <div
                              id={"tab2collapseOne" + index}
                              class="collapse"
                              aria-labelledby={"tab2headingOne" + index}
                ...
                <div class="tab-pane" id="pag3" role="tabpanel">
                  <div id="accordion3" class="myaccordion">
                    {scheduling.length > 0
                      ? scheduling.map((res, index) => (
                          <div class="card">
                            <div
                              class="card-header"
                              id={"tab3headingOne" + index}
                            >
                              <button
                                class="d-flex align-items-center justify-content-between btn btn-link collapsed"
                                data-toggle="collapse"
                                data-target={"#tab3collapseOne" + index}
                                aria-expanded="false"
                                aria-controls="collapseOne"
                              >
                                {res.question}
                            ...
                            <div
                              id={"tab3collapseOne" + index}
                              class="collapse"
                              aria-labelledby={"tab3headingOne" + index}
