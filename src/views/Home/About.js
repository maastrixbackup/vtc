...
export default function About() {
  ...
  useEffect(() => {
    const obj = { authenticate_key: "abcd123XYZ" };
    postRecord(APIGetAboutData, obj).then((res) => {
      //console.log(res);
      if (res.data[0].response.status === "success") {
                ...
                <div class="row">
                      ...
                      {Object.keys(aboutData).length > 0 ? (
                        <div
                          ...
                          dangerouslySetInnerHTML={{
                            __html: aboutData.personalhistory.desc,
                          }}
                        ></div>
                      ) : (
                        <Skeleton
                  ...
                  <div class="col-lg-6 col-md-6">
                    <div class="personal_history_right">
                      {Object.keys(aboutData).length > 0 ? (
                        <img
                          src={aboutData.personalhistory.image}
                          alt=""
                          title=""
                        />
                      ) : (
                      ...
                      <span class="year_exp " id="viewportPendulum">
                        ...
                        {Object.keys(aboutData).length > 0 ? (
                          <div
                            // eslint-disable-next-line react/no-danger
                            dangerouslySetInnerHTML={{
                              __html: aboutData.personalhistory.year_exp,
                            }}
                          ></div>
                        ) : (
                          <Skeleton
            ...
            <div class="row">
              <div class="col-lg-6 col-md-12">
                <div
                  ...
                  style={{ backgroundImage: "url(" + subImage + ")" }}
                >
                  &nbsp;
                </div>
              </div>
                          ...
                          <p>
                            {Object.keys(aboutData).length > 0 ? (
                              <div
                                ...
                                // eslint-disable-next-line react/no-danger
                                dangerouslySetInnerHTML={{
                                  __html: aboutData.our_mission.desc,
                                }}
                              ></div>
                            ) : (
                              <Skeleton
                          ...
                          <p>
                            {Object.keys(aboutData).length > 0 ? (
                              <div
                                ...
                                // eslint-disable-next-line react/no-danger
                                dangerouslySetInnerHTML={{
                                  __html: aboutData.our_vision.desc,
                                }}
                              ></div>
                            ) : (
                              <Skeleton
          ...
          <div class="row justify-content-center">
            <div class="col-lg-12">
              <div class="recent_projects_head pb-4">
                <h2>Meet Our Team</h2>
                <p>
                  In addition to myself and my much, much better-half and
                  co-founder, Hannele Rinta-Tuuri, we have built a team of
                  caring people from around the world who share the same values
                  and vision as we do for our customers. We feel truly blessed
                  to be able to help families both here in the United States as
                  well as other countries put food on the table and provide for
                  their families! Thank you for helping us make our dream come
                  true!
                </p>
              </div>
            </div>
            ...
            {teamList.length > 0
              ? teamList.map((res) => (
                  <div class="col-lg-4 col-md-4 col-sm-6">
                    <div
                      class="team-member-two wow fadeInUp delay-0-2s animated"
                      style={{
                        visibility: "visible",
                    ...
                    >
                      <div class="image">
                        ...
                        {/* <div class="social-style-two">
                          ...
                          <a href={res.twitter_url}>
                            <i class="fab fa-twitter"></i>
                          </a>
                          <a href={res.instagram_url}>
            ...
            <div class="col-lg-12 col-md-12">
              ...
              <div class="section-padding whouse-logo">
                <OwlCarousel
                  margin={10}
                  {...options1}
                  class="screenshot_slider owl-carousel"
                >
                  {partnerData.map((res) => (
                    <div class="item">
